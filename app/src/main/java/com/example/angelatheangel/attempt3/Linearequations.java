...
/* This class handles the button press from the quiz, when the button is right it increments score, and toasts, otherwise it toasts. it gets its questions and options and answers by calling a library class and then loading the data. If it is the last question the class calls the results class */
    ...
    public class Linearequations extends AppCompatActivity {

    private LinearequationsQlibrary mQuestionLibrary= new LinearequationsQlibrary();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_linearequations);
        ...
        mButtonChoice1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view){
                ...
                if(mButtonChoice1.getText()==mAnswer){
                    mScore=mScore+1;
                    updateScore(mScore);
                    Toast.makeText(Linearequations.this, "Well Done", Toast.LENGTH_SHORT).show();
                    if(mQuestionNumber==5)
                    {
                        Intent i=new Intent(Linearequations.this, ResultsActivity.class);
                        Bundle bundle=new Bundle();
                        bundle.putInt("final score",mScore);
                        i.putExtras(bundle);
                        Linearequations.this.finish();
                        startActivity(i);
                    }
                    else{
                        updateQuestion();
                    ...
                    Toast.makeText(Linearequations.this, "Next Time", Toast.LENGTH_SHORT).show();
                    if(mQuestionNumber==5)
                    {
                        Intent i=new Intent(Linearequations.this, ResultsActivity.class);
                        Bundle bundle=new Bundle();
