...
public class factorisingrevision extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_factorisingrevision);
        TextView generalfeedback=findViewById(R.id.integersandnegativenumbersgeneralfeedback);

        generalfeedback.setText("Factorising brackets is reapplying inverse Bodmas but with algebra");
        final MediaPlayer factorising =MediaPlayer.create(this, R.raw.factorising);
