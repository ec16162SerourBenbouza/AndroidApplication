...
public class Trig extends AppCompatActivity {
    ...
    private TrigQlibrary mQuestionLibrary= new TrigQlibrary();
        ...
        mButtonChoice1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view){
                ...
                if(mButtonChoice1.getText()==mAnswer){
                    mScore=mScore+1;
                    updateScore(mScore);
                    Toast.makeText(Trig.this, "Well Done", Toast.LENGTH_SHORT).show();
                    if(mQuestionNumber==5)
                    {
                        Intent i=new Intent(Trig.this, ResultsActivity.class);
                    ...
                    Toast.makeText(Trig.this, "Next Time", Toast.LENGTH_SHORT).show();
                    if(mQuestionNumber==5)
                    {
                        Intent i=new Intent(Trig.this, ResultsActivity.class);
                        Bundle bundle=new Bundle();
