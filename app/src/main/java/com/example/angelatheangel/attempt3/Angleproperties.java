...
public class Angleproperties extends AppCompatActivity {

    private AnglepropertiesQlibrary mQuestionLibrary= new AnglepropertiesQlibrary();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_angleproperties);
        ...
        mButtonChoice1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view){
                ...
                if(mButtonChoice1.getText()==mAnswer){
                    mScore=mScore+1;
                    updateScore(mScore);
                    Toast.makeText(Angleproperties.this, "Well Done", Toast.LENGTH_SHORT).show();
                    if(mQuestionNumber==5)
                    {
                        Intent i=new Intent(Angleproperties.this, ResultsActivity.class);
                        Bundle bundle=new Bundle();
                        bundle.putInt("final score",mScore);
                        i.putExtras(bundle);
                        Angleproperties.this.finish();
                        startActivity(i);
                    }
                    else{
                        updateQuestion();
                    ...
                    Toast.makeText(Angleproperties.this, "Next Time", Toast.LENGTH_SHORT).show();
                    if(mQuestionNumber==5)
                    {
                        Intent i=new Intent(Angleproperties.this, ResultsActivity.class);
                        Bundle bundle=new Bundle();
