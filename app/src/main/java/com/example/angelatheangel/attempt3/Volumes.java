...
public class Volumes extends AppCompatActivity {
    ...
    private VolumesQlibrary mQuestionLibrary= new VolumesQlibrary();
        ...
        mButtonChoice1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view){
                ...
                if(mButtonChoice1.getText()==mAnswer){
                    mScore=mScore+1;
                    updateScore(mScore);
                    Toast.makeText(Volumes.this, "Well Done", Toast.LENGTH_SHORT).show();
                    if(mQuestionNumber==5)
                    {
                        Intent i=new Intent(Volumes.this, ResultsActivity.class);
                    ...
                    Toast.makeText(Volumes.this, "Next Time", Toast.LENGTH_SHORT).show();
                    if(mQuestionNumber==5)
                    {
                        Intent i=new Intent(Volumes.this, ResultsActivity.class);
                        Bundle bundle=new Bundle();
