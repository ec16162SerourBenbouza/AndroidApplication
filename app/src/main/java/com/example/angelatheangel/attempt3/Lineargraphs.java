...
public class Lineargraphs extends AppCompatActivity {

    private LineargraphsQlibrary mQuestionLibrary= new LineargraphsQlibrary();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lineargraphs);
        ...
        mButtonChoice1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view){
                ...
                if(mButtonChoice1.getText()==mAnswer){
                    mScore=mScore+1;
                    updateScore(mScore);
                    Toast.makeText(Lineargraphs.this, "Well Done", Toast.LENGTH_SHORT).show();
                    if(mQuestionNumber==5)
                    {
                        Intent i=new Intent(Lineargraphs.this, ResultsActivity.class);
                        Bundle bundle=new Bundle();
                        bundle.putInt("final score",mScore);
                        i.putExtras(bundle);
                        Lineargraphs.this.finish();
                        startActivity(i);
                    }
                    else{
                        updateQuestion();
                    ...
                    Toast.makeText(Lineargraphs.this, "Next Time", Toast.LENGTH_SHORT).show();
                    if(mQuestionNumber==5)
                    {
                        Intent i=new Intent(Lineargraphs.this, ResultsActivity.class);
                        Bundle bundle=new Bundle();
