...
public class Factorising extends AppCompatActivity {

    private FactorisingQlibrary mQuestionLibrary= new FactorisingQlibrary();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_factorising);
        ...
        mButtonChoice1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view){
                ...
                if(mButtonChoice1.getText()==mAnswer){
                    mScore=mScore+1;
                    updateScore(mScore);
                    Toast.makeText(Factorising.this, "Well Done", Toast.LENGTH_SHORT).show();
                    if(mQuestionNumber==5)
                    {
                        Intent i=new Intent(Factorising.this, ResultsActivity.class);
                        Bundle bundle=new Bundle();
                        bundle.putInt("final score",mScore);
                        i.putExtras(bundle);
                        Factorising.this.finish();
                        startActivity(i);
                    }
                    else{
                        updateQuestion();
                    ...
                    Toast.makeText(Factorising.this, "Next Time", Toast.LENGTH_SHORT).show();
                    if(mQuestionNumber==5)
                    {
                        Intent i=new Intent(Factorising.this, ResultsActivity.class);
                        Bundle bundle=new Bundle();
