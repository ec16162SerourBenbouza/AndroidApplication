...
public class Trainscenario extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_trainscenario);
    ...
    { Toast.makeText(Trainscenario.this, "Well Done", Toast.LENGTH_SHORT).show();
        option2.setBackgroundColor(getResources().getColor(R.color.color4));

    }
    public void score2(View view)
    { Toast.makeText(Trainscenario.this, "Well Done", Toast.LENGTH_SHORT).show();
        option5.setBackgroundColor(getResources().getColor(R.color.color4));
    ...
    public void wrongans(View view){
        Toast.makeText(Trainscenario.this, "Next Time", Toast.LENGTH_SHORT).show();
    ...
    public void videoplayer(View video)
    {
        ...
        String videolocation = "android.resource://com.example.angelatheangel.attempt3/"+R.raw.trainscenario;
