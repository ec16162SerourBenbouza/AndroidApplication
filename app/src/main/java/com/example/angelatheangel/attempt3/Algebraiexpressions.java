...
public class Algebraiexpressions extends AppCompatActivity {

    private AlgebraiexpressionsQlibrary mQuestionLibrary= new AlgebraiexpressionsQlibrary();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_algebraiexpressions);
        ...
        mButtonChoice1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view){
                ...
                if(mButtonChoice1.getText()==mAnswer){
                    ...
                    {
                        Intent i=new Intent(Algebraiexpressions.this, ResultsActivity.class);
                        Bundle bundle=new Bundle();
                        bundle.putInt("final score",mScore);
                        i.putExtras(bundle);
                        Algebraiexpressions.this.finish();
                        startActivity(i);
                    }
                    else{
                        updateQuestion();
