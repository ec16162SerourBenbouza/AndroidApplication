...
public class Ratio extends AppCompatActivity {
    ...
    private RatioQlibrary mQuestionLibrary= new RatioQlibrary();
        ...
        mButtonChoice1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view){
                ...
                if(mButtonChoice1.getText()==mAnswer){
                    mScore=mScore+1;
                    updateScore(mScore);
                    Toast.makeText(Ratio.this, "Well Done", Toast.LENGTH_SHORT).show();
                    if(mQuestionNumber==5)
                    {
                        Intent i=new Intent(Ratio.this, ResultsActivity.class);
                    ...
                    Toast.makeText(Ratio.this, "Next Time", Toast.LENGTH_SHORT).show();
                    if(mQuestionNumber==5)
                    {
                        Intent i=new Intent(Ratio.this, ResultsActivity.class);
                        Bundle bundle=new Bundle();
