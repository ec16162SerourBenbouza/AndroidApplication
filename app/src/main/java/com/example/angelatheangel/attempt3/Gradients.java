...
public class Gradients extends AppCompatActivity {
    ...
    private GradientsQlibrary mQuestionLibrary= new GradientsQlibrary();
        ...
        mButtonChoice1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view){
                ...
                if(mButtonChoice1.getText()==mAnswer){
                    mScore=mScore+1;
                    updateScore(mScore);
                    Toast.makeText(Gradients.this, "Well Done", Toast.LENGTH_SHORT).show();
                    if(mQuestionNumber==5)
                    {
                        Intent i=new Intent(Gradients.this, ResultsActivity.class);
                        Bundle bundle=new Bundle();
                        bundle.putInt("final score",mScore);
                        i.putExtras(bundle);
                        Gradients.this.finish();
                        startActivity(i);
                    }
                    else{
                        updateQuestion();
                    ...
                    Toast.makeText(Gradients.this, "Next Time", Toast.LENGTH_SHORT).show();
                    if(mQuestionNumber==5)
                    {
                        Intent i=new Intent(Gradients.this, ResultsActivity.class);
                        Bundle bundle=new Bundle();
