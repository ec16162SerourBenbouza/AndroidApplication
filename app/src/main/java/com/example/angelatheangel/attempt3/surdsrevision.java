...
public class surdsrevision extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_surdsrevision);

        TextView generalfeedback=findViewById(R.id.integersandnegativenumbersgeneralfeedback);

        generalfeedback.setText("A way to write irrational numbers in mathematics ");
        final MediaPlayer surds =MediaPlayer.create(this, R.raw.surds);
