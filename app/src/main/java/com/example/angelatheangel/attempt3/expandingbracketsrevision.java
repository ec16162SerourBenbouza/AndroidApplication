...
public class expandingbracketsrevision extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_expandingbracketsrevision);
        TextView generalfeedback=findViewById(R.id.integersandnegativenumbersgeneralfeedback);

        generalfeedback.setText("Taking Bodmas one step further");
        final MediaPlayer expand =MediaPlayer.create(this, R.raw.expandingbrackets);
